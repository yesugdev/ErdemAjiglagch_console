...
from deepseek_api import DeepSeekAPI  # Assuming you have a DeepSeekAPI client
...
class ExcelAnalyzerGUI:
    def __init__(self, root):
        ...
        self.deepseek = DeepSeekAPI(api_key="your_deepseek_api_key_here")
    ...
    def generate_report(self):
        ...
        try:
            # Using DeepSeek API instead of OpenAI
